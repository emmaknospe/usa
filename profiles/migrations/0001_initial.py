    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_picture', models.ImageField(null=True, upload_to='images')),
                ('description_text', models.CharField(max_length=2000)),
                ('donor_type', models.CharField(choices=[('I', 'Individual'), ('B', 'Business'), ('F', 'Foundation')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('profile_type', models.CharField(choices=[('S', 'Student'), ('A', 'Admin'), ('D', 'Donor')], default='A', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='StudentProfile',
